...
# COMPLETAR - INICIO
inter = conjunto_03.intersection(conjunto_04)
print(inter)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
union = conjunto_05.union(conjunto_06)
print(union)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
dif = conjunto_07.difference(conjunto_08)
print(dif)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
dif_sim = conjunto_09 ^ conjunto_10
print(dif_sim)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
dif_sim = conjunto_09.symmetric_difference(conjunto_10)
print(dif_sim)
# COMPLETAR - FIN
